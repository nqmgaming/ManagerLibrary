...
import com.nqmgaming.managerlibrary.ui.manager.EditCategoryBookActivity
...
import com.nqmgaming.managerlibrary.databinding.ItemCategoryBinding
            ...
            binding.btnDeleteCategory.setOnClickListener {
                ...
                bindingConfirm.btnYes.setOnClickListener {
                    ...
                    if (result) {
                        ...
                        val response = categoryBookDAO.deleteCategoryBook(categoryBook.id)
                        if (response > 0) {
